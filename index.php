...
<html>
	...
	function editar(id, tarefa) {
		...
		// criar input hidden para armazenar o input da tarefa 
		...
		// limpar o texto da tarefa que contem o form 
		tarefaDiv.innerHTML = '';
						...
						<div class="row">
							<div class="col">
								...
								<div class="row mb-3 d-flex align-items-center tarefa">
									<div 
										class="col-sm-9" id="tarefa_<?php echo $tarefa->id?>">
